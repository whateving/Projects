...
spanning-tree vlan 3-4 priority 24576
spanning-tree vlan 2,7,20 priority 28672
...
interface Vlan1
 ...
 shutdown
interface Vlan2
 mac-address 000b.be5d.cd01
 ip address 192.168.2.2 255.255.255.0
 ip helper-address 192.168.7.100
interface Vlan3
 mac-address 000b.be5d.cd02
 ip address 192.168.3.2 255.255.255.0
 ip helper-address 192.168.7.100
interface Vlan4
 mac-address 000b.be5d.cd03
 ip address 192.168.4.2 255.255.255.0
 ip helper-address 192.168.7.100
interface Vlan7
 mac-address 000b.be5d.cd04
 ip address 192.168.7.2 255.255.255.0
 ip access-group SERVERS_ACL out
interface Vlan20
 mac-address 000b.be5d.cd05
 ip address 192.168.20.2 255.255.255.0
 ip helper-address 192.168.7.100
interface Vlan24
 mac-address 000b.be5d.cd06
